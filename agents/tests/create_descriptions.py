...
def create_cluster_yaml(input_file, cluster_name):
    ...
    cluster_yaml_filename = f"cluster-{cluster_name}.yaml"  # Updated to use cluster_name
...
def create_worker_node_yaml(input_file, cluster_name, continuum_layer):
    """
    ...
    for worker_name in worker_nodes.keys():
        worker_context = {
            ...
            "continuum_layer": continuum_layer,
...
def create_continuum_yaml(input_file):
    ...
    continuum_yaml_filename = "continuum.yaml"
...
def main():
    ...
    for cluster_name in inventory['all']['children']:
        try:
            ...
            create_worker_node_yaml(input_file, cluster_name, continuum_layer)
